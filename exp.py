...
if __name__ == '__main__':
    rt = sys.argv[1]
    if rt == 'yinshi':
        sex, age, height, weight, yundong = sys.argv[2:7]
        print(json.dumps(yinshi(int(sex),int(age),int(height),int(weight),int(yundong))))
    elif rt == 'yundong':
        sex,age,type,bing = sys.argv[2:6]
        print(json.dumps(yundong(int(sex),int(age),int(type),int(bing))))
    else:
        sex, age, type, fuyong, bing, xue = sys.argv[2:8]
        print(json.dumps(kongtang(int(sex),int(age),int(type),int(fuyong),int(bing),int(xue))))
